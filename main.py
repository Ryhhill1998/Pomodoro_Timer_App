...
def count_down(count):
    ...
    if count > 0:
        ...
        start_timer()
        sessions_completed = math.floor(reps/2)
        check_marks = "✅" * sessions_completed
...
start_button.config(padx=5, pady=5, font=("Arial", 15))
start_button.grid(column=0, row=2)

reset_button = Button(text="Reset", command=reset_timer)
reset_button.config(padx=5, pady=5, font=("Arial", 15))
